...
const routes = [
  { path: "/", component: () => import("./components/top_route/TheHome") },
  {
    path: "/view",
    ...
    children: [
      {
        path: "",
        component: () => import("./components/top_route/score_viewer/TheDetail")
      },
      {
        path: "lamp",
      ...
      {
        path: "stat",
        component: () => import("./components/top_route/score_viewer/TheStat")
      },
      {
        path: "recent",
        component: () => import("./components/top_route/score_viewer/TheRecent")
      },
      {
        path: "rival",
        component: () => import("./components/top_route/score_viewer/TheRival")
      }
    ]
  },
